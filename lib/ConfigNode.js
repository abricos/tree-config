...
ConfigNode.prototype = {
    ...
    _configImport: function(file){
        ...
        try {
            ...
            var msg = 'Access denied or JSON syntax error in `' + file + '`';
            throw new Error(msg);
        }
    ...
    _overrideImport: function(cwd){
        ...
        var file = path.resolve(cwd, this._appConfig.OVERRIDE_CONFIG_FILE);
    ...
    init: function(options){
        ...
        var jsonFile = path.resolve(cwd, this._appConfig.CONFIG_FILE),
            json = this._configImport(jsonFile);
